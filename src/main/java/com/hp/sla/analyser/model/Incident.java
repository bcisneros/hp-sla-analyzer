...
public class Incident implements Comparable<Incident>, Cloneable {
	...
	public void setConfigurationItemITAssetOwnerAssignmentGroupOrganizationLevel4Name(
			String configurationItemITAssetOwnerAssignmentGroupOrganizationLevel4Name) {
	...
	public void setRelatedRootConfigurationItemApplicationPortfolioIdentifier(
			long relatedRootConfigurationItemApplicationPortfolioIdentifier) {
	...
	public void setRelatedRootConfigurationItemBusinessFriendlyName(
			String relatedRootConfigurationItemBusinessFriendlyName) {
	...
	public void setConfigurationItemITAssetOwnerAssignmentGroupOrganizationLevel1Name(
			String configurationItemITAssetOwnerAssignmentGroupOrganizationLevel1Name) {
	 ...
	 *            the service level agreement that corresponds to this kind of
	 *            incident
	...
	public Timestamp calculateBurnedOutDate(ServiceLevelAgreement serviceLevelAgreement) throws SlaAnalysisException {
		if (serviceLevelAgreement.getBurnedOut() == null) {
			throw new SlaAnalysisException(
					"It is not defined a Burned Out Rate for " + serviceLevelAgreement.getName() + " SLA.");
		}
		return new Timestamp(
				creationTimestamp.getTime() + DateTimeUtil.hoursToMilliseconds(serviceLevelAgreement.getBurnedOut()));
	}
	 ...
	 * @throws SlaAnalysisException
	 *             when the time to fix is not defined for the combination of
	 *             priority and criticality of the incident
	 */
	public Timestamp calculateTimeToFixDeadLine(ServiceLevelAgreement serviceLevelAgreement)
		...
		if (serviceLevelAgreement.getTimeToFix() == null) {
			throw new SlaAnalysisException(
					"It is not defined a Time to Fix for " + serviceLevelAgreement.getName() + " SLA.");
		}
		return new Timestamp(
				creationTimestamp.getTime() + DateTimeUtil.hoursToMilliseconds(serviceLevelAgreement.getTimeToFix()));
	}
	 ...
	 *
	 * @param assignmentGroupsListToAnalize
	 *            the list of the assigment groups of interest
	 */
