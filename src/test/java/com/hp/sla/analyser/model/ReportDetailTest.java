...
public class ReportDetailTest {
    ...
    public void testGetBurnedOutComplianceStringWithBurnedOutIncident() {
        ...
        assertEquals(BurnedOutStatus.NON_COMPLIANCE.getName(), instance.getBurnedOutComplianceString());
    }
    ...
    public void testGetBurnedOutComplianceStringWithNotBurnedOutIncident() {
        ...
        assertEquals(BurnedOutStatus.COMPLIANCE.getName(), instance.getBurnedOutComplianceString());
    }
    ...
    public void testGetBurnedOutComplianceStringWithIndeterminatedBurnedOutIncidentStatus() {
        ...
        assertEquals(BurnedOutStatus.UNDETERMINED.getName(), instance.getBurnedOutComplianceString());
    }
